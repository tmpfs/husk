...
ConcatStream.prototype.getBody = getBody;
ConcatStream.prototype.inferEncoding = inferEncoding;
...
module.exports = through.transform(transform, flush, {ctor: ConcatStream});
