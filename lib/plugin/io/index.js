...
function stream(source, target, sopts, topts) {
  return new FileStream(source, target, sopt, topts);
}
...
function plugin() {
  ...
  // instance stream transform creation
  this.file = function file(source, target) {
    return this.fuse(stream(source, target, sopts, topts));
  }
